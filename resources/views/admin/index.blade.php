        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th>Nama Makanan</th>
                    <th>Jumlah</th>
                    <th>Status</th> <!-- Tambahkan kolom untuk status -->
                    <th>Aksi</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($donationRequests as $request)
                    <tr>
                        ...
                        <td>{{ ucfirst($request->status) }}</td> <!-- Menampilkan status -->
                        <td>
                            ...
                            @else
                                <p class="text-success">Disetujui</p> <!-- Menampilkan teks jika disetujui -->
                            @endif
                        </td>
                    </tr>
                @endforeach
