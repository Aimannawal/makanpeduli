...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
        ...
        <footer class="bg-gray-100 dark:bg-gray-800 py-8 px-6">
            <div class="container mx-auto">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="mb-4 md:mb-0">
                        <a href="#" class="text-2xl font-bold text-primary-600 dark:text-primary-400">MakanPeduli</a>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">© 2023 MakanPeduli. All rights reserved.</p>
                    </div>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                @if(Auth::check())
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('toko.index') }}">Toko Dashboard</a>
                        </li>
                    @endif
