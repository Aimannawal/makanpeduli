...
<header class="border-b border-gray-200 dark:border-gray-800 p-4 bg-white dark:bg-gray-900 text-gray-900 dark:text-white fixed top-0 left-0 right-0 z-20">
    <div class="flex justify-between items-center">
        <div class="flex items-center">
            <button id="sidebarToggle" class="mr-2 lg:hidden focus:outline-none">
...
<div class="flex pt-16 min-h-screen">
    <!-- Sidebar -->
    <aside id="sidebar" class="w-64 -translate-x-full transform transition-transform duration-300 lg:translate-x-0 lg:ml-0 mt-16 fixed top-0 left-0 h-full border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 z-10 md:block flex flex-col justify-between">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        sidebarToggle.addEventListener('click', () => {
            // Toggle the 'translate-x-0' class to slide the sidebar in and out
